...
const apiVacancies = require('../api/vacancies');
const apiCategories = require('../api/categories');
const apiApplications = require('../api/applications');
...
const start = (container) => {
  return new Promise((resolve, reject) => {
    ...
    apiVacancies.bind(null, { repo, middlewares })(app);
    apiCategories.bind(null, { repo, middlewares })(app);
    apiApplications.bind(null, { repo, middlewares })(app);
